-- =============================================
-- SPORT PLANITY - SUPABASE RESET & SETUP
-- This script can be run multiple times safely
-- =============================================

-- 1. DROP ALL EXISTING POLICIES (Safe)
-- =============================================
...
drop policy if exists "Coach availability is viewable by everyone" on public.coach_availability;
...
drop policy if exists "Admins can view club invitations" on public.invitations;
...
-- 3. DROP EXISTING FUNCTIONS & TRIGGERS
-- =============================================
